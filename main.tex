...
\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``When the reactor is loaded with fresh fuel, its reactivity margin (to put it simply, the capacity for growth of neutron power) exceeds the capacity of the absorbing rods to suppress the reaction. In such a case, part of the fuel (assemblies) is removed and in their place fixed absorbing rods are inserted (they are called supplementary absorbers -- DP), as if to assist the movable rods. As the uranium burns up, the DP are removed and nuclear fuel is installed in their place.}
...
Oh, how he digs! He unearthed the button. But he is not the first. It appears in the forensic experts' records and in the Indictment. The button was installed not two weeks beforehand but on 25~April, as witness electrician Molts testified. Without the program, the operators could have established nothing.
...
A group of IAEA experts issued in 1986 the report INSAG-1 on the causes of the Chernobyl catastrophe, and seven years later released their corrected report, INSAG-7. Seven years is ample time for studying many investigations and forming one's own judgment. Upon the publication of INSAG-7, the journal ``Nuclear Engineering'' printed an article by Mr.~J.~Varley, ``Who Is to Blame for the Chernobyl Accident -- Mature Reflections of the International Nuclear Safety Advisory Group.'' Let us try to assess the maturity of the experts' reflections.
...
At such a steam-void coefficient the power coefficient reaches \qty{+0.6e-4}{\betaeff\per\mega\watt} above \qty{50}{\percent} power. At lower power it is even more positive.
...
If Mr.~Varley concluded -- using the factual material of the appendices -- that the accusations are unjust, then he is correct. But such a conclusion is impossible from the INSAG report alone; indeed, it points in the opposite direction.
...
Only the lack of legal grounds for prosecuting the staff forced Legasov and Abagyan, in 1986, to resort to outright falsehood. Their motives are intelligible. What is astonishing is how readily the experts adopted this line, assuming the role of accusers -- condemning people before the world for violating documents the experts themselves had never seen. Bound by their first report, they were compelled to maintain the same direction in the second.

INSAG-7, like its predecessor, misinterprets processes; and even where its general statements are accurate, its tendentious framing renders them false. It cannot play a constructive role.
...
V.~A.~Kurunosov \hfill 28.09.86\\[0.5\baselineskip]
\textbf{Approved by:}\\
Deputy Director of Enterprise P.O.~Box A-7291\\
M.~Cherkashov \hfill 27.09.86\\[0.5\baselineskip]
\textbf{Approved by:}\\
...
\item A panel for the automatic logging of emergency-protection trips was assembled and placed in service.
...
Pending the implementation of the reconstruction measures for the first-generation NPPs with RBMK-1000 reactors recommended by the IVTS decisions of 1984 (installation of check valves in all distribution group headers, modernization of the emergency cooling system, etc.), the maximum design-basis accident for the first stage of the Chernobyl NPP is taken to be a rupture of the downcomer pipeline of \qty{300}{\milli\metre} diameter. Under such an accident, reactor shutdown and cooling of the active zone by the emergency cooling system, the feedwater pumps, and the emergency feedwater pumps are ensured.
